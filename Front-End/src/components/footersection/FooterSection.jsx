...
const FooterSection = () => {        
    return (
        <section className="py-10 !bg-grey-500 sm:pt-16 lg:pt-24">
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                <img className="w-auto h-9" src={logo} alt="" />

                <p className="text-base leading-relaxed text-gray-600 mt-7">Monitor your hives anytime, anywhere BeeTrack keeps your bees safe</p>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    ...
                    <li>
                        <a href="#features" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Features </a>
                    </li>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="https://www.seengineering-tn.com/" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Customer Support </a>
                    </li>

                    <li>
                        <a href="https://www.seengineering-tn.com/" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Delivery Details </a>
                    </li>

                    <li>
                        <a href="https://www.seengineering-tn.com/" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Terms & Conditions </a>
                    </li>

                    <li>
                        <a href="https://www.seengineering-tn.com/" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Privacy Policy </a>
                    </li>
                </ul>
            </div>
...
<p className="text-sm text-center text-gray-600">
  © Copyright {new Date().getFullYear()}, All Rights Reserved by BeeTrack®
</p>
    </div>
</section>
